var visibility=0;	//1-видно корабли противника, 0-не видно
...
function perekid(){						//перекидивание значений координат кораблей на поле
...
function cons(ships){		//проверка массива со значениями координат корабля, Выведение в консоль
	for (var i = 0 ; i< 10; i++) {
